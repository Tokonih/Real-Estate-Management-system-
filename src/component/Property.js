...
function Property() {
  ...
  useEffect(() => {
    fetch(
      "http://property.reworkstaging.name.ng/v1/properties?merchant=64b7cd2411d45559c8840b5a&verified=true",
      {
              ...
              {verified.map((item) => (
                <div className="property-dsc">
                  ...
                  <div className="price-details">
                    ...
                    <h6>
                      <LuBed className="shower" /> {item.bedroom}beds{" "}
                      <LuBath className="shower" /> {item.badroom}baths
                    </h6>
